...
<body>
  ...
  <center>
  <form name="searchWDS" method = "POST">
  <h3 style='color:rgb(0, 140, 255); padding-left: 5%;padding-top: 1%;letter-spacing: 1px;'>
  Which WDS information do you want to enter?</h3>
  <input type="text" name="WDSsrch" placeholder = "WDS number"/>
...
<?php
  if(count($_POST)>0){
  $SearchWDS = $_POST['WDSsrch'];
  $_SESSION['WDSsrch'] = $SearchWDS;
header("Location: WDSIN1.php");
}?>
</p>
