    ...
    <div class="col-md-12">
      <form  method="post">
        ...
        <fieldset>
          ...
          <legend><span class="number">1</span>Date and Time</legend>
        ...
        <?php
            $sql = "INSERT INTO wtpinfo VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?);";
            if(isset($_POST['chloride'])){
            $statement = $conn->prepare($sql);
            $statement->bind_param('issiidddddddddd',$_SESSION['wtpsrch'],$_POST['date'],$_POST['time'],$_POST['waterin'],$_POST['waterout'],$_POST['turbidity'],$_POST['pH'],
            ...
            ?>
            <center>
            <a class="btn btn-outline-success" href = "WTP2.php">View Data</a>
        </center>
       </form>
        </div>
      </div>
