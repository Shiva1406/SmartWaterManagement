...
<body>
  ...
  <center>
  <form name="searchWTP" method = "POST">
  <h3 style='color:rgb(0, 140, 255); padding-left: 5%;padding-top: 1%;letter-spacing: 1px;'>
  Which WTP information do you want to enter?</h3>
  <input type="text" name="wtpsrch" placeholder = "Wtp number"/>
...
<?php
  if(count($_POST)>0){
  $SearchWTP = $_POST['wtpsrch'];
  $_SESSION['wtpsrch'] = $SearchWTP;
header("Location: WTPIN1.php");
}?>
</p>
